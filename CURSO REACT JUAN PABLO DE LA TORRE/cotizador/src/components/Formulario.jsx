    ...
    <>
        ...
        <form onSubmit={handleSubmit}>
            <div className='my-5'>
                ...
                <select name="marca" className='w-full p-3 bg-white border-gray-200' id="marca" onChange={e=>handleChange(e)} value={datos.marca}>
            ...
            <div className='my-5'>
                ...
                <select name="year" className='w-full p-3 bg-white border-gray-200' id="year" onChange={e=>handleChange(e)} value={datos.year}>

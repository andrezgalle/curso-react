...
const Proyecto = () => {
  ...
  const {obtenerProyecto,proyecto,cargando,handleModalTarea,alerta,submitTareasProyecto,eliminarTareasProyecto,actualizarTareaProyecto,actualizarEstadosProyecto} = useProyectos()
  ...
  useEffect(()=>{
    ...
    socket.on('nuevo estado', nuevoEstadoTarea =>{
      if(nuevoEstadoTarea.proyecto._id === proyecto._id){
        actualizarEstadosProyecto(nuevoEstadoTarea)
      }
    })
  })
